	...
	{#await waitLocale() then}
		...
		<div class="body">
			...
			<ul>
				...
				<li>
					<strong>Application</strong> refers to ElmiNote, the software program provided by the Company.
				</li>
				<li>
					<strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
					Agreement) refers to Company.
				</li>
			...
			<ul>
				<li>
					<a class="link" href="https://firebase.google.com/policies/analytics" target="_blank">
						Google Analytics for firebase
					</a>
				</li>
				<li>
					<a class="link" href="https://firebase.google.com/support/privacy/" target="_blank">
