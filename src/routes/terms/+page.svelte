...
<div class='component'>
	{#await waitLocale() then}
		...
		<div class="body">
			...
			<p class="text">Please read these terms and conditions carefully before using Our Service. </p>
            ...
            <ul>
                <li><strong>Application </strong>means the software program provided by the Company downloaded by You on any electronic device, named ElmiNote</li>
                ...
                <li><strong>Company </strong>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ElmiNote.</li>
