		...
		<div class="body">
			...
			<ul>
				<li>
					...
					by You on any electronic device, named ElmiNote
				</li>
				<li>
				...
				<li>
					...
					the Service. This Terms and Conditions agreement has been created with the help of the
